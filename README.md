...
<p align="center">
 <img src="https://images.edrawmax.com/what-is/gitflow-diagram/3-git-workflow.png">
</p>
...
and then to initialise the pre-commit hook.
...
This template has a FastAPI app in the `app` directory that can be used as a starting point for your API.
...
This will start the app in development mode, and will automatically reload the app when you make changes to the code.

#### API Docs

FastAPI has built-in support for [OpenAPI](https://swagger.io/specification/) (formerly Swagger) and [ReDoc](<https://redocly.com/>) for API documentation.

In order to view the API docs, once you have launched the app, go to [http://localhost:8000/docs](http://localhost:8000/docs) or [http://localhost:8000/redoc](http://localhost:8000/redoc).
